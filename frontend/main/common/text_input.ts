...
export declare interface HorizontalTextInput {
  on(event: "enter", listener: () => Promise<void> | void): this;
}

export class HorizontalTextInput extends EventEmitter {
  ...
  public static create(label: string): HorizontalTextInput {
    return new HorizontalTextInput(label);
  }
