...
export interface AccountBasicComponent {
  on(event: "changeAvatar", listener: () => void): this;
}

export class AccountBasicComponent extends EventEmitter {
  ...
  public static create(): AccountBasicComponent {
    return new AccountBasicComponent(WEB_SERVICE_CLIENT).init();
  }
