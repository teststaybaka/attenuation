...
import { TALE_CONTEXT, TaleContext } from "../../../../interface/tale_context";
import {
  GET_QUICK_TALE,
    ...
    new (class implements TestCase {
      ...
      public async execute() {
        ...
        this.container = E.div(
          {},
          E.div({ style: `position: fixed;` }, ...cut.menuBodies),
          E.div(
    ...
    new (class implements TestCase {
      ...
      public async execute() {
        ...
        this.container = E.div(
          ...
          E.div({ style: `position: fixed;` }, ...cut.menuBodies),
          E.divRef(
            controllerContainerRef,
            { style: `position: fixed; right: 0;` },
            ...cut.controllerBodies
          ),
          cut.body
        );
        cut.on("bodies", (bodies) => this.container.append(...bodies));
        cut.on("controllerBodies", (controllerBodies) =>
